...
public class FloatingActionButton extends ImageButton {
    ...
    void updateBackground() {
        ...
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{getResources().getDrawable(mSize ==
                SIZE_NORMAL ? R.drawable.fab_bg_normal : R.drawable.fab_bg_mini), createFillDrawable(strokeWidth),
    ...
    private Drawable createCircleDrawable(int color, float strokeWidth) {
        ...
        LayerDrawable drawable = alpha == 255 || !mStrokeVisible ? new LayerDrawable(layers) : new
    ...
    private Drawable createInnerStrokesDrawable(final int color, float strokeWidth) {
        ...
        shapeDrawable.setShaderFactory(new ShaderFactory() {
            ...
            public Shader resize(int width, int height) {
                return new LinearGradient(width / 2, 0, width / 2, height, new int[]{topStrokeColor,
                        topStrokeColorHalfTransparent, color, bottomStrokeColorHalfTransparent, bottomStrokeColor},
