...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mButtonSpacing = (int) (getResources().getDimension(R.dimen.fab_actions_spacing) - getResources()
                .getDimension(R.dimen.fab_shadow_radius) - getResources()
        ...
        switch (mExpandDirection) {
            ...
            case EXPAND_DOWN:
                ...
                int labelsXNearButton = mLabelsPosition == LABELS_ON_LEFT_SIDE ? buttonsHorizontalCenter -
                        labelsOffset : buttonsHorizontalCenter + labelsOffset;

                int nextY = expandUp ? addButtonY - mButtonSpacing : addButtonY + mAddButton.getMeasuredHeight() +
                        mButtonSpacing;
                ...
                for (int i = mButtonsCount - 1; i >= 0; i--) {
                    ...
                    ViewCompat.setTranslationY(child, mExpanded ? expandedTranslation : collapsedTranslation);
                    ViewCompat.setAlpha(child, mExpanded ? 1f : 0f);
                    ...
                    if (label != null) {
                        int labelXAwayFromButton = mLabelsPosition == LABELS_ON_LEFT_SIDE ? labelsXNearButton - label
                                .getMeasuredWidth() : labelsXNearButton + label
                                .getMeasuredWidth();
                        ...
                        ViewCompat.setTranslationY(label, mExpanded ? expandedTranslation : collapsedTranslation);
                        ViewCompat.setAlpha(label, mExpanded ? 1f : 0f);
            ...
            case EXPAND_RIGHT:
                ...
                mAddButton.layout(addButtonX, addButtonTop, addButtonX + mAddButton.getMeasuredWidth(),
                        addButtonTop + mAddButton
                                .getMeasuredHeight());

                int nextX = expandLeft ? addButtonX - mButtonSpacing : addButtonX + mAddButton.getMeasuredWidth() +
                        mButtonSpacing;
